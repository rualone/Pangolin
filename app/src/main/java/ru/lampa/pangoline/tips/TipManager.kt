...
package ru.lampa.pangoline.tips

import android.app.Activity
import android.content.Context
import android.os.Build
import mozilla.components.browser.session.Session
import ru.lampa.pangoline.R.string.app_name
import ru.lampa.pangoline.R.string.tip_add_to_homescreen
import ru.lampa.pangoline.R.string.tip_autocomplete_url
import ru.lampa.pangoline.R.string.tip_disable_tips2
import ru.lampa.pangoline.R.string.tip_disable_tracking_protection
import ru.lampa.pangoline.R.string.tip_explain_allowlist
import ru.lampa.pangoline.R.string.tip_open_in_new_tab
import ru.lampa.pangoline.R.string.tip_request_desktop
import ru.lampa.pangoline.R.string.tip_set_default_browser
...
import ru.lampa.pangoline.utils.homeScreenTipsExperimentDescriptor
import ru.lampa.pangoline.utils.isInExperiment
